<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BstMuaXuan.aspx.cs" MasterPageFile="~/SiteMaster.Master" Inherits="WebApplication2.WebForm2" %>
        ...
        <div id="contentmain">
            ...
            <div id="right">
                <div class="llRootRowItem">
                 ...
                 <div class="llRootRowItem">
                    <%-- Row 2 --%>
                    <div class="title-spnb"  id="bst-mua-he">
                        <div class="dv-xemtatca"><a href="#" class="a-xemtatca">Xem tất cả>></a></div>
                    </div>
                    <div class="llRowItem">
                  ...
                  <div class="llRootRowItem">
                    <%-- Row 3--%>
                    <div class="title-spnb"  id="bst-mua-thu">
                        <div class="dv-xemtatca"><a href="#" class="a-xemtatca">Xem tất cả>></a></div>
                    </div>
                    <div class="llRowItem">
                ...
                </div>  <div class="llRootRowItem">
                    <%-- Row 4 --%>
                    <div class="title-spnb"  id="bst-mua-dong">
                        <div class="dv-xemtatca"><a href="#" class="a-xemtatca">Xem tất cả>></a></div>
                    </div>
                    <div class="llRowItem">
                    ...
                    <%-- Row 5 --%>
                    <div class="title-spnb"  id="phukien-thoitrang">
                        <div class="dv-xemtatca"><a href="#" class="a-xemtatca">Xem tất cả>></a></div>
                    </div>
                    <div class="llRowItem">
